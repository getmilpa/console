...
final class ConfirmTokenStore implements ConfirmTokens
{
    ...
    /**
     * Spends the token, answering whether it was valid for THIS operation and still fresh.
     *
     * The token is dropped even when it does not match: a wrong guess must not leave a live token
