...
final class CliProjectorSignatureGateTest extends TestCase
{
    ...
    private function project(CliRunner $projector, array $argv): int
    {
        $this->out = [];
    ...
    public function test_the_old_flag_no_longer_authorizes_anything(): void
    {
        ...
        $exit = $this->project(new CliRunner(), ['--name=MailPlugin', '--yes']);
    ...
    {
        $projector = new CliRunner(signer: $this->signer(secondsAgo: null));
    ...
    public function test_an_expired_authorization_stops_the_operation_and_says_what_to_do(): void
    {
        ...
        $projector = new CliRunner(signer: $this->signer(secondsAgo: 300), authorizer: $this->authorizer());
    ...
    {
        $projector = new CliRunner(signer: $this->signer(), authorizer: $this->authorizer(signatureVerifies: false));
    ...
    {
        $projector = new CliRunner(signer: $this->signer(), authorizer: $this->authorizer(nonceIsFresh: false));
    ...
    {
        $projector = new CliRunner(signer: $this->signer(), authorizer: $this->authorizer());
    ...
    public function test_a_non_confirmable_operation_is_untouched(): void
    {
        ...
        $this->out = [];
        $exit = (new CliRunner())->run($unattended, [], $this->container(), function (string $l): void {
            $this->out[] = $l;
        });
