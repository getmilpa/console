...
$config = new Milpa\Docs\SiteConfig(
    brand: 'Milpa Console',
    nsPrefix: 'Milpa\\Console\\',
    installCommand: 'composer require milpa/console',
    repoUrl: 'https://github.com/getmilpa/console',
    pagesUrl: 'https://getmilpa.github.io/console/',
    heroParagraph: 'The projection layer of the Milpa PHP framework: surface projectors that turn one declared Operation into the shape each surface speaks — CLI flags, MCP tools — plus the signature gate that makes consent name the call.',
    utmContent: 'console',
);
